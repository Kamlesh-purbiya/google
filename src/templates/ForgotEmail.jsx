        ...
        <div className="forgot-container">
            <div className="forgot-content">
                ...
                <div className="forgot-left">
                    ...
                    <h1 className="forgot-title">Find your Google Account</h1>
                    <p className="forgot-subtitle">Enter your email or phone number</p>
                </div>
                ...
                <div className="forgot-right">
                    ...
                    <div className="button-group-forgot">
                        <button className="back-button" onClick={handleBack}>Back</button>
                        <button className="next-button-forgot" onClick={handleNext}>Next</button>
                    </div>
                </div>
            </div>
